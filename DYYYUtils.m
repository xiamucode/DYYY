...
+ (void)writeMediaInfo:(NSDictionary *)mediaInfo
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
      ...
      NSString *outputPath = [DYYYUtils cachePathForFilename:[NSString stringWithFormat:@"media_info_%@.%@", [NSUUID UUID].UUIDString, imageURL.pathExtension.length > 0 ? imageURL.pathExtension : @"jpg"]];
